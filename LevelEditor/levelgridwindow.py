...
class LevelGridWindow(ScrolledWindow):
	def __init__(self,level_editor,x,y,width,height):
		...
		self.connect_signal(SIG_MOUSEDOWN,self.level_grid.testClick,self.calculate_offset) #TEMP (but will probably connect this signal here)
	...
	def calculate_offset(self):
		...
		#print ((x_scroll_offset,y_scroll_offset))
